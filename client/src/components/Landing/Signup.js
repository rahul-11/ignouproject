...
const validate = formValues => {
  ...
  if (!password) {
    ...
    errors.password = 'Your Password should be atleast six character long';

  if (!confirm_password) {
    errors.confirm_password = 'Please confirm your Password.';
  } else if (password && password.localeCompare(confirm_password))
    errors.confirm_password = 'Your Password does not match';

  if (!terms_checkbox)
    errors.terms_checkbox =
      'Please read and agree to terms and conditions to continue';
